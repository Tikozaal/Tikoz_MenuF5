    ...
    Events = {
		onSelected = function(self, _, btn, PMenu, menuData, currentButton, currentBtn, currentSlt, result, slide)
                    ...
                    if quantity ~= nil then
                        ...
                        if foundPlayers == true then
                            ...
                            if not IsPedSittingInAnyVehicle(closestPed) then
                                if post == true then
                                    if item == walletMoney then
                                        TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(tikozaal.closestPlayer), 'item_money', 'money', quantity)
                                        TaskPlayAnim(PlayerPedId(), "mp_common", "givetake2_a", 2.0, 2.0, 1000, 51, 0, false, false, false)
                                        OpenMenu("Portefeuille")
                                    end
                                else
            ...
            elseif btn.name == "Give ~g~cash" then
                tik = KeyboardInput("Combien vous voulez ? ", "", "", 15)
            ...
            if btn.name == "Téléporté un joueur à moi" then
                local id = KeyboardInput("Quel est l'id ? ", "", "", 5)
            ...
            if btn.name == "Setjob" then
                ...
                local job = KeyboardInput("Nom du job", "", "", 15)
                local grade = KeyboardInput("Quel grade ? ", "", "", 3)
            ...
            elseif btn.name == "Give item" then
                local player = GetPlayerServerId(PlayerId())
                local item = KeyboardInput("Nom de l'item", "", "", 15)
